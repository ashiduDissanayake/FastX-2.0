...
const JWT_SECRET = process.env.SECRET4; // Load secret from environment variables or config

const authenticateToken = (req, res, next) => {
    const token = req.cookies.managertoken; // Ensure your cookies middleware is enabled
    if (!token) {
